...
public class RegisteredRetentionService {
    ...
    private void daysRetention(List<Long> dauUserList, ChannelInfo channelInfo, String businessDate, int i) {
        ...
        setRetention(retention, userCount, i);
    ...
    private void setRetention(DatawareFinalRegisteredRetention retention, int userCount, int i) {
        if (i == 1) {
            retention.setRegisteredDau2(Long.valueOf(userCount));
            if(retention.getNewUsers() >0){
                retention.setRetention2(BigDecimalUtil.div(retention.getRegisteredDau2(), retention.getNewUsers(), 4));
            }else {
            ...
            if(retention.getNewUsers() >0){
                retention.setRetention3(BigDecimalUtil.div(retention.getRegisteredDau3(), retention.getNewUsers(), 4));
            }else {
            ...
            if(retention.getNewUsers() >0){
                retention.setRetention4(BigDecimalUtil.div(retention.getRegisteredDau4(), retention.getNewUsers(), 4));
            }else {
            ...
            if(retention.getNewUsers() >0){
                retention.setRetention5(BigDecimalUtil.div(retention.getRegisteredDau5(), retention.getNewUsers(), 4));
            }else {
            ...
            if(retention.getNewUsers() >0){
                retention.setRetention6(BigDecimalUtil.div(retention.getRegisteredDau6(), retention.getNewUsers(), 4));
            }else {
            ...
            if(retention.getNewUsers() >0){
                retention.setRetention7(BigDecimalUtil.div(retention.getRegisteredDau7(), retention.getNewUsers(), 4));
            }else {
            ...
            if(retention.getNewUsers() >0){
                retention.setRetention8(BigDecimalUtil.div(retention.getRegisteredDau8(), retention.getNewUsers(), 4));
            }else {
            ...
            if(retention.getNewUsers() >0){
                retention.setRetention9(BigDecimalUtil.div(retention.getRegisteredDau9(), retention.getNewUsers(), 4));
            }else {
            ...
            if(retention.getNewUsers() >0){
                retention.setRetention10(BigDecimalUtil.div(retention.getRegisteredDau10(), retention.getNewUsers(), 4));
            }else {
            ...
            if(retention.getNewUsers() >0){
                retention.setRetention11(BigDecimalUtil.div(retention.getRegisteredDau11(), retention.getNewUsers(), 4));
            }else {
            ...
            if(retention.getNewUsers() >0){
                retention.setRetention12(BigDecimalUtil.div(retention.getRegisteredDau12(), retention.getNewUsers(), 4));
            }else {
            ...
            if(retention.getNewUsers() >0){
                retention.setRetention13(BigDecimalUtil.div(retention.getRegisteredDau13(), retention.getNewUsers(), 4));
            }else {
            ...
            if(retention.getNewUsers() >0){
                retention.setRetention14(BigDecimalUtil.div(retention.getRegisteredDau14(), retention.getNewUsers(), 4));
            }else {
            ...
            if(retention.getNewUsers() >0){
                retention.setRetention15(BigDecimalUtil.div(retention.getRegisteredDau15(), retention.getNewUsers(), 4));
            }else {
