...
public class RoomFishInfoNew extends DataEntity {
	...
	public String toString() {
		return "RoomFishInfo [roomId=" + roomId + ", fishId=" + fishId + ", userId=" + userId + ", fishConfigId="
				+ fishConfigId + ", amount=" + amount + ", returnAmount=" + returnAmount + ", roadId=" + roadId
