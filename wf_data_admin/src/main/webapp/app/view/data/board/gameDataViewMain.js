            ...
            for (var i = 0; i < items.length; i++) {
                ...
                for (var z = 0; z < data.dateList.length; z++) {
                    ...
                    if (items[i].id.indexOf("次留") > -1
                        && mdDate > Ext.util.Format.date(Ext.Date.add(new Date(), Ext.Date.DAY, -1), "Y-m-d")) {
                        break;
                    }
                    if (items[i].id.indexOf("三留") > -1
                        && mdDate > Ext.util.Format.date(Ext.Date.add(new Date(), Ext.Date.DAY, -3), "Y-m-d")) {
                        break;
                    }
                    if (items[i].id.indexOf("七留") > -1
                        && mdDate > Ext.util.Format.date(Ext.Date.add(new Date(), Ext.Date.DAY, -7), "Y-m-d")) {
                        break;
                    }
                    ...
                    for (var i = 0; i < seriesData[key].length; i++) {
                        ...
                        for (var j = 0; j < seriesData[key][i].length; j++) {
                            if (item.indexOf("次留") > -1
                                && data.dateList[j] > Ext.util.Format.date(Ext.Date.add(new Date(), Ext.Date.DAY, -1), "Y-m-d")) {
                                break;
                            }
                            if (item.indexOf("三留") > -1
                                && data.dateList[j] > Ext.util.Format.date(Ext.Date.add(new Date(), Ext.Date.DAY, -3), "Y-m-d")) {
                                break;
                            }
                            if (item.indexOf("七留") > -1
                                && data.dateList[j] > Ext.util.Format.date(Ext.Date.add(new Date(), Ext.Date.DAY, -7), "Y-m-d")) {
                                break;
                            }
                            var str = [];
