Ext.define('WF.view.thirdChannel.channelThirdBettingMain', {
    extend: 'Ext.panel.Panel',
    title: '投注数据概览',
    xtype: 'channelThirdBettingMain' + this.parameters + '',
    closable: true,
    layout: {
        type: 'vbox',
        align: 'stretch'
    ...
    initComponent: function () {
        ...
        var store = Ext.create('DCIS.Store', {
            ...
            fields: ['businessDate', 'channelName', 'gameType', 'userCount',
