Ext.define('WF.view.game.taurus.taurusOverviewMain', {
    extend: 'Ext.panel.Panel',
    title: '乐赢拼十-数据概览',
    xtype: 'taurusOverviewMain',
    closable: true,
    layout: {
        type: 'vbox',
        align: 'stretch'
    ...
    initComponent: function () {
        ...
        var store = Ext.create('DCIS.Store', {
            autoLoad: true,
            url: 'data/admin/taurus/getList.do',
        ...
        me.add({
            ...
            tbar: [{
                ...
                handler: function () {
                    ...
                    Ext.create('WF.view.game.taurus.showTips', {doRefresh: doRefresh}).show();
                }
            }],
            columns: [ {
                text: '日期',
